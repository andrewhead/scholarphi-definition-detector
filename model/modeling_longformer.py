...
# from transformers.modeling_longformer import ROBERTA_PRETRAINED_MODEL_ARCHIVE_LIST
...
class Longformer(BertPreTrainedModel):
    ...
    def __init__(self, config, args, intent_label_lst, slot_label_lst, pos_label_lst):
        ...
        self.longformer = LongformerModel(config=config)  # Load pretrained bert
