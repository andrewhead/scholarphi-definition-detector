...
class Albert(AlbertPreTrainedModel):
    ...
    def forward(self, input_ids, attention_mask, token_type_ids, intent_label_ids, slot_labels_ids, pos_label_ids=None, np_label_ids=None, vp_label_ids=None, entity_label_ids=None, acronym_label_ids=None):
